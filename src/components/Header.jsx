...
export const Header = () => {
  ...
  return (
    <header className="  mx-auto  max-w-screen-2xl bg-.Very-Pale-Blue  dark:bg-.Very-Dark-Blue-top h-[235px] rounded-b-[20px] pt-8 px-6 mb-[1050px] md:mb-[540px]  lg:mb-[280px] xl:mb-[280px] 2xl:mb-[280px]">
